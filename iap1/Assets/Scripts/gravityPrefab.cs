...
public class gravityPrefab : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //        this.GetComponent<Rigidbody>().AddForce(transform.up * Random.Range(0.5f, 2.0f) * 0.0f);
        //    }
        //    else
        //    {
        //        gravity = true;
        ...
        //}
            ...
            if (gravity && Physics.gravity.y== 0.0f)
            {
                ...
                //this.GetComponent<Rigidbody>().useGravity = false;
                //Physics.gravity = new Vector3(0.0f, 0.0f, 0.0f);
                rigibody.AddForce(transform.up * UnityEngine.Random.Range(0.5f, 2.0f) * 5.0f);
            }
        ...
        // para se pare en el aire cuando llegue a cierto valor de Y
        position = this.transform.position;
        if (!gravity && position.y > UnityEngine.Random.Range(0.05f, 0.07f)) {
            //Destroy(rigibody);
